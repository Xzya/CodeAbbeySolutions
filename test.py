...
def compute():
  ...
  for i1 in range(0, n1):
    ...
    orig_translate.append([txy1[i1][:], xy1[i1][:]])
  ...
  index = 0
  for i in range(0, n1):
    if orig_translate[i][0] == txy1[wi1]:
      index = i
      break

  print(int(temp1.index(xy0[wi0][0])/2), "", end="")
  print(int(temp2.index(orig_translate[index][1][0])/2), "", end="")
